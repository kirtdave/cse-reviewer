  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6">
      ...
      <motion.section
        ...
        className={`${isDark ? "bg-gray-900/60" : "bg-white/60"} backdrop-blur-xl rounded-2xl p-6 w-full lg:w-[70%] border ${isDark ? "border-gray-800" : "border-gray-200"} shadow-xl max-h-[500px] overflow-y-auto`}
      >
        <h2 className="text-lg font-bold mb-6 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
      ...
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.6 }}
        className="flex flex-col w-full lg:w-[30%] gap-4"
      >
