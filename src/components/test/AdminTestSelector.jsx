          ...
          <div className={`p-4 lg:p-6 border-b ${isDark ? 'border-gray-800' : 'border-gray-200'}`}>
            <div className="flex items-center justify-between mb-3 lg:mb-4">
              <div className="flex items-center gap-2 lg:gap-3 flex-1 min-w-0">
                <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className={`text-xs lg:text-sm mt-0.5 lg:mt-1 truncate ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    Official tests by admins
                  </p>
                </div>
              </div>
              <button
          ...
          <div className="flex-1 overflow-y-auto p-4 lg:p-6">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 lg:py-20">
                ...
                <h3 className={`text-lg lg:text-xl font-semibold mb-2 text-center ${isDark ? 'text-white' : 'text-gray-900'}`}>
                  {searchQuery ? 'No tests found' : `No ${testType} tests available`}
                </h3>
                <p className={`text-xs lg:text-sm text-center px-4 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                  {searchQuery 
                    ...
                    >
                      <div className="flex items-start justify-between gap-3 lg:gap-4">
                        <div className="flex items-start gap-3 lg:gap-4 flex-1 min-w-0">
                          <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center flex-shrink-0">
                            <Shield className="w-6 h-6 lg:w-7 lg:h-7 text-white" />
                          </div>
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1 flex-wrap">
                              <h3 className={`text-base lg:text-lg font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                {test.title}
                              </h3>
                              <span className="px-2 lg:px-3 py-0.5 lg:py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-cyan-500 to-blue-500 text-white">
                                {testType}
                              </span>
                            </div>
                            {test.description && (
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`px-4 lg:px-6 py-2 rounded-xl font-semibold text-sm transition-all ${
                  isDark 
                    ? 'bg-gray-800 text-gray-300 active:bg-gray-750' 
