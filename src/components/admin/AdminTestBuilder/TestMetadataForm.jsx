...
export default function TestMetadataForm({ 
  ...
  return (
    <div className="p-6 rounded-2xl space-y-6" style={{ backgroundColor: cardBg, border: `1px solid ${borderColor}` }}>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            ...
            className={`p-4 rounded-xl transition-all ${testType === 'Practice' ? 'ring-2' : ''}`}
            style={{
          ...
          >
            <div className="flex items-center gap-3">
              <BookOpen className="w-6 h-6" style={{ color: primaryGradientFrom }} />
              <div className="text-left">
                <h4 className="font-bold" style={{ color: textColor }}>Practice Test</h4>
          ...
          <button
            ...
            className={`p-4 rounded-xl transition-all ${testType === 'Mock' ? 'ring-2' : ''}`}
            style={{
          ...
          >
            <div className="flex items-center gap-3">
              <Trophy className="w-6 h-6" style={{ color: primaryGradientFrom }} />
              <div className="text-left">
                <h4 className="font-bold" style={{ color: textColor }}>Mock Exam</h4>
